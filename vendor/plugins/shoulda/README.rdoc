...
If you're using Shoulda with RSpec, we recommend that you add Gemfile lines
for RSpec and Shoulda but do not auto-require the RSpec and Shoulda libraries:

  only :test do
    gem 'rspec',       :require_as => nil
    gem 'rspec-rails', :require_as => nil
    gem 'shoulda',     :require_as => nil
  end
...
Shoulda is maintained by Thoughtbot[http://www.thoughtbot.com], inc.
